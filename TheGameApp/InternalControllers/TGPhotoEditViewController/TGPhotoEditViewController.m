...
@interface TGPhotoEditViewController ()
@property (nonatomic, strong) UIImage *image;
@property (nonatomic, strong) UIScrollView *filterScrollView;
@end

@implementation TGPhotoEditViewController
{
...
- (void)viewDidLoad
{
    ...
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"Отмена" style:UIBarButtonItemStyleBordered target:self action:@selector(cancelButtonAction:)];
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"Да!" style:UIBarButtonItemStyleDone target:self action:@selector(addButtonAction:)];
                          ...
                          [library assetForURL:assetURL resultBlock:^(ALAsset *asset)
                           {
                               ...
                               [self addDataFromPhotoEdit:asset];
...
{
    if([delegate respondsToSelector:@selector(addDataFromPhotoEdit:)])
    {
        [delegate addDataFromPhotoEdit:asset];
    }
}
